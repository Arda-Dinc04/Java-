...
{ 
    ...
    private int up;
    private int down;
    private ArrayList<String> areaInventory;
    ...
    { 
        ...
        up = NO_EXIT;
        down = NO_EXIT;
        areaInventory = new ArrayList<String>();
    ...
    public ArrayList<String> getAreaInventory()  
    {
    ...
    public void addItem(String newItem)
    {
        if (newItem == null)
            ...
            areaInventory.add(newItem);
    }

    public boolean removeItem(String oldItem)
    {
        int location = areaInventory.indexOf(oldItem);
        
        if(location >= 0)
        {
            areaInventory.remove(location);
            return true;
        }
        else
            return false;
